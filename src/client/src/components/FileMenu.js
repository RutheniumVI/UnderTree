...
function FileMenu({ currentFile, setCurrentFile }) {
  ...
  useEffect(() => {
    axios
      .get(
        "http://localhost:8000/api/file/getFiles?owner=" +
          owner +
          "&projectName=" +
          projectName,
    ...
    if (path.length == 1) {
      ...
      for (let i = 0; i < tree.folders.length; i++) {
        if (tree.folders[i].name === path[0]) {
          tree.folders[i] = createFileTreeNode(
            tree.folders[i],
            path.slice(1),
            file,
            currPath + "/" + path[0]
  ...
  function renderFileMenu(tree, root) {
    return (
      <SubMenu
        label={tree.name}
        key={tree.path}
        rootStyles={{ backgroundColor: "#DEDEDE" }}
      >
        ...
        {tree.files.map((file) => [
          ...
          >
            <div className="form-check form-check-inline">
              ...
              />
              <label
                className="form-check-label fileName"
                onClick={(e) => {
                  setCurrentFile(file);
                }}
              >
  ...
  function handleConfirmFileUploadClick() {
    ...
    if (fileType === "image/png" || fileType == "image/jpeg") {
      ...
      axios
        .post("http://localhost:8000/api/file/uploadImage", formData, {
          withCredentials: true,
  ...
  function handleConfirmNewFileClick() {
    ...
    axios
      .post(
        "http://localhost:8000/api/file/addFile",
        {
          owner: owner,
  ...
  function handleConfirmDeleteClick() {
    ...
    axios
      .post(
        "http://localhost:8000/api/file/deleteFile",
        {
          owner: owner,
          projectName: projectName,
  ...
  function handleEditFileConfirm() {
    ...
    axios
      .post(
        "http://localhost:8000/api/file/renameFile",
        {
          owner: owner,
          projectName: projectName,
    ...
    <div>
      <div className="my-card">
        <div>
          ...
          ></i>
          <i
            className="bi bi-cloud-upload fileButton"
            data-bs-toggle="modal"
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-header my-modal-header">
              <h1 className="modal-title fs-5" id="fileUploadLabel">
                File Upload
              </h1>
              <button
                type="button"
            ...
            <div className="modal-body my-modal-body">
              ...
              {isExtension ? <p>Do not include extension</p> : null}
            ...
            <div className="modal-footer my-modal-footer">
              ...
              <button
                ...
                data-bs-dismiss="modal"
                onClick={handleConfirmFileUploadClick}
              >
                Confirm
              </button>
            </div>
          ...
          <div className="modal-content">
            ...
            <div className="modal-footer my-modal-footer">
              ...
              <button
                ...
                className="btn btn-dark"
                data-bs-dismiss="modal"
                onClick={handleConfirmNewFileClick}
              >
                Confirm
              </button>
            </div>
      ...
      >
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-header my-modal-header">
              <h1 className="modal-title fs-5" id="editFileLabel">
                Edit File
              </h1>
              <button
                type="button"
      ...
      >
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-header my-modal-header">
              <h1 className="modal-title fs-5" id="deleteFileLabel">
                Delete File
              </h1>
              <button
                type="button"
