...
\newpage
	...
	\begin{itemize}
		...
		\item \textbf{Git}: Shorthand for Git
		\item \textbf{GitHub} A \textbf{git} version control management system   
		...
		\item \textbf{Repository}: Central location where all version history of data is stored
	...
	\begin{enumerate}[resume*]
		\item The system's code will only be view-able to the public through the \textbf{Git} repository
	...
	\begin{enumerate}[resume*]
		...
		\item The system shall protect itself from intentional abuse
	\end{enumerate}
	...
	\begin{table}[H]
		...
		\begin{tabular}{l|l|l|l|l|l|}
			\cline{2-6}
			& NFR3 & NFR7 & NFR11 & NFR28 & NFR29 \\ \hline
